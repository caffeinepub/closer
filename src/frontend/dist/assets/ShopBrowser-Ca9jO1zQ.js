import { c as createLucideIcon, r as reactExports, g as useActiveShops, h as useActiveShopsByCategory, j as jsxRuntimeExports, B as Button, M as MapPin, S as Skeleton, i as useShopProducts, k as usePlaceOrder, D as Dialog, l as DialogContent, m as DialogHeader, n as DialogTitle, o as useShopAverageRating, p as useShopReviews, q as useAddShopReview, T as Textarea, f as ue } from "./index-DJGrdZh3.js";
...
import { B as BUSINESS_CATEGORIES, S as ShoppingCart } from "./categories-C3iAvrlZ.js";
/**
    ...
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShopRatingBadge, { shopId: shop.id }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShopReviewSection, { shop }),
...
function ShopRatingBadge({ shopId }) {
...
function StarSelector({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        color: star <= value ? "hsl(40,90%,50%)" : "hsl(var(--muted-foreground))"
      },
...
function ShopReviewSection({ shop }) {
  ...
  const [myRating, setMyRating] = reactExports.useState(0);
  const [myComment, setMyComment] = reactExports.useState("");
  const handleSubmit = () => {
    if (myRating === 0) {
      ue.error("Tafadhali chagua nyota");
      return;
    }
    addReview.mutate(
  ...
  const avgScore = avgRating && avgCount > 0 ? (Number(avgRating[0]) / 10).toFixed(1) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5", "data-ocid": "shop_review.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "h3",
      {
        className: "font-semibold text-sm mb-2",
        style: { color: "hsl(var(--foreground))" },
        children: "Maoni ya Wateja"
      }
    ),
    avgScore && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StarSelector, { value: myRating, onChange: setMyRating }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          value: myComment,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: addReview.isPending ? "Inatuma..." : "Tuma Maoni"
        }
      )
    ] }),
    ...
    ) : !reviews || reviews.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: "text-xs py-2",
        style: { color: "hsl(var(--muted-foreground))" },
        "data-ocid": "shop_review.empty_state",
        children: "Hakuna maoni bado"
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: reviews.map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCard, { review, idx: i }, review.id.toString())) })
  ] });
}
function ReviewCard({ review, idx }) {
  const stars = Number(review.rating);
  const date = review.timestamp ? new Date(Number(review.timestamp) / 1e6).toLocaleDateString(
    "sw-TZ",
    {
      day: "numeric",
      month: "short",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              style: { color: "hsl(var(--foreground))" },
              children: review.userName || "Mtumiaji"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: [1, 2, 3, 4, 5].map((si) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-sm",
              style: {
                color: si <= stars ? "hsl(40,90%,50%)" : "hsl(var(--muted-foreground))"
              },
              children: si <= stars ? "⭐" : "☆"
            },
            `star-${si}`
        ...
        review.comment && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-xs",
            style: { color: "hsl(var(--muted-foreground))" },
