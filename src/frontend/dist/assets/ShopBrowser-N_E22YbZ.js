import { c as createLucideIcon, g as useActiveShops, r as reactExports, j as jsxRuntimeExports, B as Button, M as MapPin, S as Skeleton, h as useShopProducts, i as usePlaceOrder, D as Dialog, k as DialogContent, l as DialogHeader, m as DialogTitle, f as ue } from "./index-DNU0UyjY.js";
...
function ShopModal({
  ...
  const [paymentInfo, setPaymentInfo] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "hsl(var(--card-foreground))" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShopAvatar, { shop, size: 64 }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-lg", children: shop.name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          shop.paymentNumbers && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "hsl(var(--foreground))" },
                    children: "💳 Namba za Malipo / Payment Numbers"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 rounded-xl" }, i)) }) : products && products.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: products.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProductCard,
            {
              product: p,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Komisho (10%):" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                        "TZS ",
                        (Number(orderProduct.price) * qty * 0.1).toFixed(0)
                      ] })
                    ] })
                  ]
                }
        ...
        paymentInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "mt-4 p-4 rounded-xl border",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "✅ Agizo limewekwa! / Order placed!"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
              ...
              paymentInfo.paymentNumbers ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-sm font-medium mb-1",
                  style: { color: "hsl(var(--foreground))" },
                  children: paymentInfo.paymentNumbers
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-xs",
                  style: { color: "hsl(var(--muted-foreground))" },
                  children: "Wasiliana na duka kwa maelezo ya malipo."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "hsl(var(--muted-foreground))" },
                  children: 'Baada ya kulipa, nenda kwenye "Maagizo Yangu" kupakia uthibitisho.'
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
...
function ShopBrowser() {
  ...
  reactExports.useEffect(() => {
    var _a;
    (_a = navigator.geolocation) == null ? void 0 : _a.getCurrentPosition(
  ...
  const filtered = shopsWithDistance.filter(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex items-center justify-between", children: userPos ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "hsl(var(--muted-foreground))" },
                  children: "Hakuna maduka yaliyopatikana"
                }
              )
            ]
          }
