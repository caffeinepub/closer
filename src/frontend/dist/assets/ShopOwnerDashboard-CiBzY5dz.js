import { c as createLucideIcon, r as reactExports, n as createDialogScope, j as jsxRuntimeExports, R as Root$3, T as Trigger$2, o as useComposedRefs, W as WarningProvider, p as createContextScope, q as Content$2, s as composeEventHandlers, t as createSlottable, v as Title, w as Description, x as Close, P as Portal$1, O as Overlay, y as cn, z as buttonVariants, A as React2, E as createSlot, F as reactDomExports, G as Primitive, H as useLayoutEffect2, I as useCallbackRef, J as useDirection, K as useControllableState, L as useId, N as Portal$2, Q as hideOthers, U as useFocusGuards, V as ReactRemoveScroll, X as FocusScope, Y as DismissableLayer, Z as clamp$1, _ as Presence, $ as useInternetIdentity, a0 as useMyProfile, a as useAllShops, h as useShopProducts, a1 as useShopOrders, a2 as useMyNotifications, a3 as useAppSettings, a4 as useMyReferences, a5 as useSubmitSubscriptionReference, a6 as useCreateShop, a7 as useUpdateShop, a8 as useDeleteShop, a9 as useDeleteProduct, aa as useUpdateShopLogo, ab as useUpdateShopPaymentNumbers, ac as useToggleShopAvailability, ad as useCreateProduct, ae as useUpdateProduct, af as useUpdateOrderStatus, ag as useMarkNotificationRead, ah as useActor, ai as useQueryClient, S as Skeleton, B as Button, M as MapPin, f as ue, D as Dialog, k as DialogContent, l as DialogHeader, m as DialogTitle } from "./index-DIe64Eac.js";
import { A as Avatar, a as AvatarImage, b as AvatarFallback } from "./avatar-BIhrwSs9.js";
import { B as Badge } from "./badge-yPhPSMNw.js";
import { I as Input } from "./input-CRKst0X0.js";
import { L as Label } from "./label-DtW2pWwD.js";
import { C as ChevronDown, a as ChevronUp, b as Camera } from "./chevron-up-CMI4q4Wk.js";
import { T as Textarea } from "./textarea-DDVR4HC5.js";
import { S as ShoppingCart } from "./shopping-cart-DRZY7g-k.js";
/**
...
function playNotificationSound(type) {
  try {
    ...
    const playTone = (freq, start, duration, decay) => {
...
async function showBackgroundNotification(title, body, soundType = "beep") {
...
function ShopForm({
  ...
  const [form, setForm] = reactExports.useState(initial || emptyShopForm());
  const set = (k) => (e) => setForm((f) => ({ ...f, [k]: e.target.value }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Jina la Duka *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: form.name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Maelezo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Anwani *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: form.address,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Latitudo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: form.latitude,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Longitudo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Facebook" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: form.facebook,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "TikTok" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: form.tiktok,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Namba za Malipo / Payment Numbers" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: isPending ? "Inahifadhi..." : "Hifadhi Duka"
        }
      )
    ] })
  ] });
...
function ProductForm({
  ...
  const [preview, setPreview] = reactExports.useState(
    (initial == null ? void 0 : initial.imageUrl) || null
  );
  const fileRef = reactExports.useRef(null);
  const set = (k) => (e) => setForm((f) => ({ ...f, [k]: e.target.value }));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Picha ya Bidhaa" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 24, style: { color: "hsl(var(--muted-foreground))" } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Jina la Bidhaa *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: form.name,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Bei (TZS) *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: form.price,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Hisa *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: form.stock,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: isPending ? "Inahifadhi..." : "Hifadhi Bidhaa"
        }
      )
    ] })
  ] });
...
function ShopOwnerDashboard() {
  ...
  const myShop = (allShops == null ? void 0 : allShops.find(
    (s) => s.owner.toString() === (identity == null ? void 0 : identity.getPrincipal().toString())
  )) || null;
  const { data: products } = useShopProducts((myShop == null ? void 0 : myShop.id) || null);
  const { data: orders } = useShopOrders((myShop == null ? void 0 : myShop.id) || null);
  const { data: notifications } = useMyNotifications();
  const { data: appSettings } = useAppSettings();
  const { data: myRefs } = useMyReferences((myShop == null ? void 0 : myShop.id) || null);
  ...
  const [profileImageOpen, setProfileImageOpen] = reactExports.useState(false);
  ...
  const handleLogoUpload = (e) => {
    ...
    updateShopLogo.mutate(
      ...
      {
        onSuccess: () => ue.success("Nembo imehifadhiwa!"),
  ...
  const [showShopForm, setShowShopForm] = reactExports.useState(false);
  const [editingShop, setEditingShop] = reactExports.useState(false);
  ...
  const [notifSound, setNotifSoundState] = reactExports.useState(
    () => localStorage.getItem("notif_sound") || "beep"
  );
  const { actor } = useActor();
  const qc = useQueryClient();
  const [adminSecretInput, setAdminSecretInput] = reactExports.useState("");
  const [claimingAdmin, setClaimingAdmin] = reactExports.useState(false);
  const [showForceResetInput, setShowForceResetInput] = reactExports.useState(false);
  const [forceResetSecret, setForceResetSecret] = reactExports.useState("");
  const [forceResetting, setForceResetting] = reactExports.useState(false);
  const [isAdminClaimed, setIsAdminClaimed] = reactExports.useState(false);
  const setNotifSound = (val) => {
  ...
  async function handleClaimAdmin() {
    ...
    try {
      ...
      if (claimed) {
        ...
        ue.success("✅ Umepata haki za Admin! Sasa una udhibiti kamili.", {
          duration: 6e3
        });
        return;
      }
      if (adminSecretInput.trim()) {
        ...
        if (isNowAdmin) {
          setIsAdminClaimed(true);
          await qc.invalidateQueries();
          ue.success("✅ Umepata haki za Admin!", { duration: 6e3 });
        } else {
          ue.error("Neno la siri si sahihi. Jaribu tena.");
        }
      } else {
        ue.error(
  ...
  const handleDeleteShop = () => {
    ...
    deleteShop.mutate(myShop.id, {
      onSuccess: () => ue.success("Duka limefutwa"),
      onError: () => ue.error("Hitilafu — jaribu tena")
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ((_b = (_a = profile == null ? void 0 : profile.profilePicture) == null ? void 0 : _a.getDirectURL) == null ? void 0 : _b.call(_a)) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-9 h-9", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    AvatarImage,
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 20, style: { color: "hsl(var(--foreground))" } }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { size: 20, style: { color: "hsl(0,70%,55%)" } })
                  }
                )
              ] })
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto pb-20", children: !myShop ? (
          /* No shop yet */
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-6", children: !showShopForm ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "hsl(var(--muted-foreground))" },
                    children: "Anza kuuza bidhaa zako mtandaoni leo hii"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4", children: [
            editingShop ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "w-14 h-14", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              AvatarImage,
                              {
                                src: ((_d = (_c = myShop.logo) == null ? void 0 : _c.getDirectURL) == null ? void 0 : _d.call(_c)) || void 0,
                                alt: myShop.name
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              AvatarFallback,
                              {
                                ...
                                children: myShop.name.slice(0, 2).toUpperCase()
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { size: 11 })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: "text-xs",
                              style: { color: "hsl(var(--muted-foreground))" },
                              children: "Picha ya Duka / Shop Logo"
                            }
                          )
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: myShop.address })
                          ]
                        }
                      ),
                      myShop.description && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-xs mt-1",
                          style: { color: "hsl(var(--muted-foreground))" },
                          children: myShop.description
                        }
                      )
                    ] }),
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  ...
                                  {
                                    style: { color: "hsl(var(--muted-foreground))" },
                                    children: "Hatua hii haiwezi kurudishwa. Duka na bidhaa zake zote zitafutwa."
                                  }
                                )
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "office.delete_shop.cancel_button", children: "Ghairi" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  AlertDialogAction,
                                  {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              style: {
                                background: myShop.isAvailable !== false ? "hsl(142,70%,45%)" : "hsl(var(--muted-foreground))"
                              }
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              style: {
                                color: myShop.isAvailable !== false ? "hsl(142,70%,45%)" : "hsl(var(--muted-foreground))"
                              },
                              children: myShop.isAvailable !== false ? "Wazi / Open" : "Imefungwa / Closed"
                            }
                          )
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            myShop && (() => {
              const now = Date.now();
              const expiryMs = Number(myShop.subscriptionExpiry) / 1e6;
              const daysLeft = Math.floor(
                (expiryMs - now) / (1e3 * 60 * 60 * 24)
              );
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: isExpired ? "hsl(0,60%,20%)" : "hsl(40,80%,15%)",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-sm font-semibold",
                          style: {
                            color: isExpired ? "hsl(0,70%,70%)" : "hsl(40,90%,70%)"
                          },
                          children: isExpired ? "Usajili umeisha / Subscription expired" : `Usajili unaisha siku ${daysLeft} / Expires in ${daysLeft} days`
                        }
                      ),
                      !myShop.isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-xs mt-1",
                          style: { color: "hsl(0,60%,65%)" },
                          children: "Duka lako halionekani kwa wateja. / Your shop is not visible to customers."
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          children: "ud83dudcb3 Lipa Ada / Pay Fee"
                        }
                      )
                    ] })
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "products", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full", "data-ocid": "office.tabs.tab", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  TabsTrigger,
                  {
                    value: "products",
                    ...
                    children: [
                      ...
                      " Bidhaa",
                      products && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1 text-xs", children: products.length })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  TabsTrigger,
                  {
                    ...
                    children: [
                      ...
                      " Maagizo",
                      orders && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1 text-xs", children: orders.length })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TabsTrigger,
                  {
                    ...
                    children: "⚙️ Mipangilio"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "products", className: "mt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    onClick: () => {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-sm",
                          style: { color: "hsl(var(--muted-foreground))" },
                          children: "Bado hujaorodhesha bidhaa"
                        }
                      )
                    ]
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: (products || []).map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: p.image.getDirectURL() ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "img",
                            {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mt-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 10, className: "inline mr-0.5" }),
                                " ",
                                "Hariri"
                              ]
                            }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "orders", className: "mt-4 space-y-3", children: !orders || orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "text-center py-8",
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  OrderRow,
                  {
                    order,
                    idx: i,
                    productName: ((_a2 = (products || []).find((p) => p.id === order.productId)) == null ? void 0 : _a2.name) || `Bidhaa #${order.productId.toString()}`,
                    onStatusChange: (status) => updateOrderStatus.mutate(
                      { orderId: order.id, status, shopId: myShop.id },
                      {
                        onSuccess: () => ue.success("Hali imesasishwa!"),
                        onError: () => ue.error("Hitilafu")
                      }
                    )
                  },
                  order.id.toString()
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "settings", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    background: "hsl(var(--card))",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h3",
                      {
                        ...
                        children: "⚙️ Mipangilio / Settings"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: "🔔 Sauti ya Arifa / Notification Sound"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: SOUND_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "label",
                            {
                              style: {
                                display: "flex",
                                ...
                                padding: "10px 14px",
                                borderRadius: 8,
                                border: notifSound === opt.id ? "2px solid hsl(var(--primary))" : "1px solid hsl(var(--border))",
                                background: notifSound === opt.id ? "hsl(var(--primary) / 0.08)" : "hsl(var(--background))",
                                cursor: "pointer",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: "🛡️ Haki za Admin / Admin Access"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              children: "Kama una neno la siri la admin, ingiza hapa ili upate uwezo wa kusimamia app yote."
                            }
                          ),
                          isAdminClaimed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                padding: "12px 16px",
                              ...
                              children: "✅ Admin access imeidhinishwa! Reload ukurasa ili uone Admin Panel."
                            }
                          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "button",
                                  {
                                    ...
                                    children: claimingAdmin ? "⏳ Inasubiri..." : "🛡️ Daka Admin (Bila Siri)"
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "p",
                                  {
                                    ...
                                    children: "Bonyeza kitufe hicho -- kama hakuna admin mwingine bado, utapata haki moja kwa moja."
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "div",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "input",
                                    {
                                      ...
                                      onKeyDown: (e) => e.key === "Enter" && adminSecretInput.trim() && handleClaimAdmin(),
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "button",
                                    {
                                      ...
                                      style: {
                                        ...
                                        fontWeight: 600,
                                        fontSize: 14,
                                        opacity: claimingAdmin || !adminSecretInput.trim() ? 0.6 : 1
                                      },
                                      children: claimingAdmin ? "..." : "Ingia"
                                    }
                                  )
                                ] })
                              ]
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              children: "⚠️ Tatizo la Admin? Tumia hii kama njia ya dharura"
                            }
                          ),
                          !showForceResetInput ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                              ...
                              children: "🔴 Futa Admin wa Zamani & Chukua Mamlaka"
                            }
                          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "button",
                                    {
                                      ...
                                      onClick: async () => {
                                        ...
                                        try {
                                          const result = await actor.forceResetAndClaimAdmin(
                                            forceResetSecret.trim()
                                          );
                                          if (result) {
                                            ue.success("✅ Umepata Mamlaka ya Admin!");
                                            ...
                                            ue.error("Neno la siri si sahihi");
                                          }
                                        } catch (_err) {
                                          ue.error("Hitilafu imetokea. Jaribu tena.");
                                        } finally {
                                          setForceResetting(false);
                                        }
                                      },
                                      disabled: forceResetting || !forceResetSecret.trim(),
                                      ...
                                      style: {
                                        ...
                                        border: "none",
                                        borderRadius: 8,
                                        cursor: forceResetting || !forceResetSecret.trim() ? "not-allowed" : "pointer",
                                        fontWeight: 700,
                                        fontSize: 14,
                                        opacity: forceResetting || !forceResetSecret.trim() ? 0.6 : 1
                                      },
                                      children: forceResetting ? "⏳..." : "✅ Thibitisha"
                                    }
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "button",
        ...
        profileImageOpen && ((_f = (_e = profile == null ? void 0 : profile.profilePicture) == null ? void 0 : _e.getDirectURL) == null ? void 0 : _f.call(_e)) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
          ...
          AlertDialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AlertDialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { style: { color: "hsl(var(--foreground))" }, children: "Futa Bidhaa?" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AlertDialogDescription,
                      {
                        style: { color: "hsl(var(--muted-foreground))" },
                        children: "Hatua hii haiwezi kurudishwa. Bidhaa itafutwa kabisa."
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Ghairi" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AlertDialogAction,
                      {
                        onClick: () => {
                          if (deleteProductId !== null) {
                            deleteProduct.mutate(deleteProductId, {
                              onSuccess: () => {
                                ue.success("Bidhaa imefutwa!");
                                setDeleteProductId(null);
                              },
                              onError: () => ue.error("Hitilafu ya kufuta")
                            });
                          }
                        },
          ...
          Dialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              DialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "hsl(var(--foreground))" }, children: "ud83dudcb3 Lipa Ada ya Usajili / Pay Subscription Fee" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: "Ada ya kila mwezi: TSH 10,000"
                      }
                    ),
                    (appSettings == null ? void 0 : appSettings.platformPaymentNumber) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-1", children: "Lipa kwa Tigo Pesa / Pay via Tigo Pesa:" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                ...
                                children: appSettings.platformPaymentNumber
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              style: { color: "hsl(var(--muted-foreground))" },
                              children: "Baada ya kulipa, weka reference number hapa chini. / After paying, enter the reference number below."
                            }
                          )
                        ]
                      }
                      ...
                      "p",
                      {
                        className: "text-sm",
                        style: { color: "hsl(var(--muted-foreground))" },
                        children: "Wasiliana na msimamizi kwa namba ya malipo."
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { style: { color: "hsl(var(--foreground))" }, children: "Reference Number (6-20 chars)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          value: refNumber,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          onClick: () => {
                            if (!myShop) return;
                            if (refNumber.trim().length < 6 || refNumber.trim().length > 20) {
                              ue.error("Reference number lazima iwe na herufi 6-20");
                              return;
                            }
                            submitRef.mutate(
                              { shopId: myShop.id, referenceNumber: refNumber.trim() },
                              {
                                ...
                                onError: () => ue.error("Hitilafu u2014 jaribu tena")
                              }
                            );
                          },
                          ...
                          children: submitRef.isPending ? "Inatuma..." : "Tuma / Submit"
                        }
                      )
                    ] }),
                    myRefs && myRefs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: "font-semibold",
                              style: { color: "hsl(var(--foreground))" },
                              children: "Zilizotumwa / Submitted:"
                            }
                          ),
                          myRefs.slice(0, 3).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "hsl(var(--foreground))" }, children: r.referenceNumber }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                style: {
                                  color: r.status === "approved" ? "hsl(120,50%,50%)" : r.status === "rejected" ? "hsl(0,60%,50%)" : "hsl(45,80%,55%)"
                                },
                                children: r.status === "approved" ? "u2713 Imeidhinishwa" : r.status === "rejected" ? "u2717 Imekataliwa" : "u23f3 Inasubiri"
                              }
                            )
                          ] }, r.id.toString()))
                        ]
          ...
          Dialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              DialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "hsl(var(--foreground))" }, children: editingProduct ? "Hariri Bidhaa" : "Bidhaa Mpya" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ProductForm,
                    {
                      ...
                      isPending: editingProduct ? updateProduct.isPending : createProduct.isPending,
                      onCancel: () => {
                        setShowProductForm(false);
                        setEditingProduct(null);
                      }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showNotifications, onOpenChange: setShowNotifications, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "hsl(var(--foreground))" }, children: "Arifa" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-96 overflow-y-auto", children: !notifications || notifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-sm text-center py-4",
                  style: { color: "hsl(var(--muted-foreground))" },
                  "data-ocid": "notifications.empty_state",
                  children: "Hakuna arifa"
                }
              ) : notifications.map((n, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                NotificationItem,
                {
                  notification: n,
                  idx: i,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            order.customerName && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                className: "text-xs font-medium",
                style: { color: "hsl(200,70%,60%)" },
                children: [
                  "ud83dudcde Wasiliana: ",
                  order.customerName,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: order.status, onValueChange: onStatusChange, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
                className: "w-36 text-xs",
                "data-ocid": `office.order.status.select.${idx + 1}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: labelMap[order.status] || order.status })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { style: { background: "hsl(var(--card))" }, children: statuses.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: labelMap[s] || s }, s)) })
          ] })
        ] }),
        order.paymentProof && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "hsl(120,50%,45%)" }, children: "✓ Uthibitisho wa malipo umepokewa" })
      ]
    }
  );
}
function NotificationItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: notification.isRead ? "hsl(var(--muted))" : "hsl(var(--accent) / 0.1)",
        borderLeft: notification.isRead ? "none" : "3px solid hsl(var(--primary))"
      },
      "data-ocid": `notifications.item.${idx + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "hsl(var(--foreground))" }, children: notification.message }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "hsl(var(--muted-foreground))" },
              children: new Date(
                Number(notification.timestamp) / 1e6
              ).toLocaleString()
            }
          )
        ] }),
