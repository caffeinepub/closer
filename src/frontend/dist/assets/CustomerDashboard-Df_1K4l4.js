import { c as createLucideIcon, u as useMyOrders, a as useAllShops, b as useAllProducts, d as useUpdatePaymentProof, j as jsxRuntimeExports, S as Skeleton, C as ClipboardList, r as reactExports, B as Button, L as LoaderCircle, e as ue } from "./index-DwseMK1H.js";
import { I as Input } from "./input-CqEZavNR.js";
import { C as CircleX, a as CircleCheckBig } from "./circle-x-8gH-7e7x.js";
/**
...
function OrderCard({
  ...
  const hasProofPending = order.paymentStatus === "pending" && order.paymentProof;
  const handleSubmitProof = () => {
    if (!selectedFile) {
      ue.error("Chagua picha ya uthibitisho wa malipo");
      return;
    }
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "hsl(var(--foreground))" },
                  children: "📎 Pakia Uthibitisho wa Malipo"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
