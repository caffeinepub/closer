import { c as createLucideIcon, r as reactExports, aj as useTheme, ak as useUpdateProfilePicture, a0 as useMyProfile, ah as useActor, ai as useQueryClient, j as jsxRuntimeExports, B as Button, f as ue } from "./index-DIe64Eac.js";
...
import { b as Camera, a as ChevronUp, C as ChevronDown } from "./chevron-up-CMI4q4Wk.js";
import { L as LoaderCircle } from "./loader-circle-CZEGMCiA.js";
/**
...
function ProfileSetup() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (showAdminSection) {
        try {
          const claimed = await actor.forceResetAndClaimAdmin(
            "ctm2026"
          );
      ...
      ue.error(`Hitilafu ya usajili: ${msg}`);
    } finally {
      setSaving(false);
    }
  };
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: "✅ Ukibonyeza “🛡️ Sajili kama Admin”, utakuwa Admin wa mfumo moja kwa moja — hata kama Admin mwingine alikuwepo awali."
                          }
                        )
                      }
                    )
