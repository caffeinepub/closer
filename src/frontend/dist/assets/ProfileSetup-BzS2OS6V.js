import { c as createLucideIcon, r as reactExports, ak as useTheme, al as useUpdateProfilePicture, a4 as useMyProfile, am as useActor, an as useQueryClient, j as jsxRuntimeExports, B as Button, L as LoaderCircle, f as ue } from "./index-DJGrdZh3.js";
...
function ProfileSetup() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (isAdminNow) {
        ue.success("✅ Umesajiliwa kama Admin!", { duration: 6e3 });
      } else {
        ue.success("✅ Umesajiliwa kikamilifu!");
      }
    } catch (err) {
