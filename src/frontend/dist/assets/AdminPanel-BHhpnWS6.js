import { c as createLucideIcon, ao as useAllUserProfiles, a as useAllShops, b as useAllProducts, ap as useAllOrdersAdmin, aq as useAppSettings, ar as useUpdateAppSettings, ah as useConfirmPayment, ai as useRejectPayment, r as reactExports, j as jsxRuntimeExports, as as ShoppingBag, S as Skeleton, B as Button, L as LoaderCircle, f as ue } from "./index-DJGrdZh3.js";
import { B as Badge } from "./badge-CxiqnDOs.js";
import { I as Input } from "./input-CgnZnuns.js";
import { L as Label } from "./label-UPgUh8F4.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, S as Store, P as Package, d as TabsContent } from "./tabs-IMIu1Xr4.js";
import { a as CircleCheckBig, C as CircleX } from "./circle-x-Cdf0V_Pi.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs space-y-0.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                label: "Bidhaa",
                value: ((_a = products.find((p) => p.id === order.productId)) == null ? void 0 : _a.name) || `Bidhaa #${order.productId.toString()}`
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              InfoRow,
              {
                label: "Duka",
                value: ((_b = shops.find((s) => s.id === order.shopId)) == null ? void 0 : _b.name) || `Duka #${order.shopId.toString()}`
              }
            ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right space-y-0.5", children: [
            ...
            Number(order.commissionAmount) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                children: [
                  "Komisho: ",
                  formatTZS(order.commissionAmount)
                ]
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PaymentStatusBadge, { paymentStatus: order.paymentStatus }) }),
        !proofUrl && order.paymentNote && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        proofUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: proofUrl,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              style: { color: "hsl(var(--primary))" },
              children: "Angalia ukubwa kamili"
            }
          )
        ] }),
        isPending && (proofBlob || order.paymentNote) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
              ...
              children: [
                isConfirming ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 12, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 12 }),
                "Thibitisha"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                isConfirming ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 12, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 12 }),
                "Kataa"
              ]
            }
          )
...
function AdminPanel() {
  ...
  const handleConfirmPayment = (orderId) => {
    confirmPayment.mutate(orderId, {
      onSuccess: () => {
        ue.success("Malipo yamethibitishwa!");
        refetchOrders();
      },
      onError: () => ue.error("Hitilafu — jaribu tena")
    });
  ...
  const handleRejectPayment = (orderId) => {
    rejectPayment.mutate(orderId, {
      onSuccess: () => {
        ue.success("Malipo yamekataliwa.");
        refetchOrders();
      },
      onError: () => ue.error("Hitilafu — jaribu tena")
    });
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "users", "data-ocid": "admin.tabs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "orders", "data-ocid": "admin.orders.panel", children: [
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [...allOrders].reverse().map((order, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              AdminOrderCard,
              {
                order,
                idx: i,
                ...
                isConfirming: confirmPayment.isPending || rejectPayment.isPending,
                products: products || [],
                shops: shops || []
              },
              order.id.toString()
